...
Inductive instruction: Type :=
  ...
  | Pfreeframe (sz: Z) (ofs_ra (* ofs_link *): ptrofs) (unrecord: bool)
      ...
      do ra <- Mem.loadv Mptr m (Val.offset_ptr rs#RSP ofs_ra);
        ...
        | Vptr stk ofs =>
          check (check_top_frame m (Some stk) sz);
            ...
            do m' <- (if unrecord then Mem.unrecord_stack_block m' else Some m');
...
Definition instr_to_string (i:instruction) : string :=
  ...
  | Pfreeframe sz ofs_ra (* ofs_link *) unrecord => "Pfreeframe"
