...
(** * Lemmas about Flatasmgen that are useful for proving match_sminj *)
...
(* All the segment labels generated by the FlatAsmgen transformation
   have valid segment ids (i.e., ids that will be mapped into valid segment blocks) *)
